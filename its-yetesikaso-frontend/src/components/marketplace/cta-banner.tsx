      ...
      <Container>
        <div className="rounded-[40px] bg-lime-400 p-10 md:p-16">
          <div className="max-w-3xl">
            <p className="mb-4 text-sm font-semibold uppercase tracking-wide text-[var(--foreground)]/70">
              Start Selling
            </p>

            <h2 className="mb-6 text-4xl font-bold text-[var(--foreground)] md:text-6xl">
